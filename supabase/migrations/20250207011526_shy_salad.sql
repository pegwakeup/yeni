/*
  ...
  1. Changes
    ...
    - Add portfolio_links and social_links
    - Update RLS policies
...
BEGIN
  ...
  DROP POLICY IF EXISTS "Anyone can upload freelancer files" ON storage.objects;
  DROP POLICY IF EXISTS "Only authenticated users can view freelancer files" ON storage.objects;
