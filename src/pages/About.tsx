                  ...
                  >
                      ...
                      <div className="mt-10 flex items-center justify-center gap-4">
                        <a
                          ...
                          className="w-12 h-12 flex items-center justify-center rounded-xl bg-white/10 backdrop-blur-sm text-white hover:bg-white/20 hover:scale-110 transition-all"
