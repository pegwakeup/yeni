            ...
            <div className="space-y-4 max-w-lg mx-auto">
              ...
              <div className="flex items-center justify-center gap-4 pt-2">
                <a
                  ...
                  className="w-11 h-11 flex items-center justify-center rounded-xl bg-gradient-to-br from-purple-500 via-pink-500 to-orange-400 text-white hover:scale-110 transition-transform"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-11 h-11 flex items-center justify-center rounded-xl bg-[#0A66C2] text-white hover:scale-110 transition-transform"
                  aria-label="LinkedIn"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-11 h-11 flex items-center justify-center rounded-xl bg-black dark:bg-white dark:text-black text-white hover:scale-110 transition-transform"
                  aria-label="TikTok"
                >
