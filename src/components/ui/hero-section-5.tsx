                    ...
                    <div className="py-24 md:pb-32 lg:pb-36 lg:pt-72">
                        <div className="relative z-10 mx-auto flex max-w-7xl flex-col px-6 lg:block lg:px-12">
                            <div className="mx-auto max-w-lg text-center lg:ml-0 lg:max-w-full lg:text-left">
                                <h1 className="mt-8 max-w-2xl text-balance text-5xl md:text-6xl lg:mt-16 xl:text-7xl">{t('demo.hero.title', 'Build 10x Faster with NS')}</h1>
                                <p className="mt-8 max-w-2xl text-balance text-lg">{t('demo.hero.subtitle', 'Highly customizable components for building modern websites and applications you mean it.')}</p>
                                ...
                                <div className="mt-12 flex flex-col items-center justify-center gap-2 sm:flex-row lg:justify-start">
                                    <Button
                                        ...
                                        <Link to="#link">
                                            <span className="text-nowrap">{t('demo.hero.start_building', 'Start Building')}</span>
                                    ...
                                    <Button
                                        ...
                                        <Link to="#link">
                                            <span className="text-nowrap">{t('demo.hero.request_demo', 'Request a demo')}</span>
                                        </Link>
                                    </Button>
                                </div>
                            </div>
                    ...
                    <div className="group relative m-auto max-w-7xl px-6">
                        <div className="flex flex-col items-center md:flex-row">
                            <div className="md:max-w-44 md:border-r md:pr-6">
                                <p className="text-end text-sm">{t('demo.hero.powering_teams', 'Powering the best teams')}</p>
                            </div>
...
const HeroHeader = () => {
    ...
    const menuItems = [
        { name: t('demo.nav.features', 'Features'), href: '#link' },
        { name: t('demo.nav.solution', 'Solution'), href: '#link' },
        { name: t('demo.nav.pricing', 'Pricing'), href: '#link' },
        { name: t('demo.nav.about', 'About'), href: '#link' },
    ]
                        ...
                        <div className="bg-background group-data-[state=active]:block lg:group-data-[state=active]:flex mb-6 hidden w-full flex-wrap items-center justify-end space-y-8 rounded-3xl border p-6 shadow-2xl shadow-zinc-300/20 md:flex-nowrap lg:m-0 lg:flex lg:w-fit lg:gap-6 lg:space-y-0 lg:border-transparent lg:bg-transparent lg:p-0 lg:shadow-none dark:shadow-none dark:lg:bg-transparent">
                            ...
                            <div className="flex w-full flex-col space-y-3 sm:flex-row sm:gap-3 sm:space-y-0 md:w-fit">
                                <Button
                                    ...
                                    size="sm">
                                    <Link to="#">
                                        <span>{t('demo.nav.login', 'Login')}</span>
                                    </Link>
                                </Button>
                                <Button
                                    asChild
                                    size="sm">
                                    <Link to="#">
                                        <span>{t('demo.nav.signup', 'Sign Up')}</span>
                                    </Link>
                                </Button>
                            </div>
                        </div>
