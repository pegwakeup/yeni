...
export function WhyUsSection() {
  ...
  return (
    <section id="neden-unilancer" className="py-12 md:py-32 relative overflow-hidden">
      <div className="max-w-[1340px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <h2 className="text-3xl md:text-6xl font-black text-slate-900 dark:text-white tracking-tighter">
            ...
            <span className="relative inline-block text-[#5FC8DA]">
              unilancer
              <svg className="absolute -bottom-2 md:-bottom-4 left-0 w-full h-4 md:h-6" viewBox="0 0 200 20" fill="none">
                <path 
        ...
        {/* Bento Grid */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 auto-rows-[minmax(240px,auto)] md:auto-rows-[minmax(280px,auto)]">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="md:col-span-1 md:row-span-2 rounded-[32px] md:rounded-[48px] bg-[#F0F4FF] dark:bg-zinc-900 p-6 md:p-8 flex flex-col relative overflow-hidden group hover:shadow-2xl hover:shadow-indigo-500/20 transition-all duration-500 border border-indigo-100 dark:border-white/5 min-h-[420px] md:min-h-0"
          >
            ...
            <div className="relative z-20 mb-4 md:mb-8">
              <h3 className="text-2xl md:text-3xl font-bold text-slate-900 dark:text-white mb-3 md:mb-4 tracking-tight">Kurumsal Kalite, Freelance Esnekliği</h3>
          ...
          <motion.div
            ...
            className="md:col-span-2 rounded-[32px] md:rounded-[48px] bg-[#FFF0F5] dark:bg-zinc-900 flex flex-col md:flex-row relative overflow-hidden group hover:shadow-2xl hover:shadow-pink-500/20 transition-all duration-500 border border-pink-100 dark:border-white/5"
          >
            {/* Dark Mode Gradient Overlay */}
            ...
            <div className="relative z-20 flex-1 p-6 md:p-8 md:pl-8 md:pr-8 flex flex-col justify-center">
              <h3 className="text-xl md:text-3xl font-bold text-slate-900 dark:text-white mb-2 md:mb-3">Tüm Dijital İhtiyaçlar İçin Tek Kaynak</h3>
            ...
            <div className="relative w-full md:w-1/3 h-48 md:h-auto md:mr-8">
               <img 
          ...
          <motion.div
            ...
            className="md:col-span-1 rounded-[32px] md:rounded-[48px] bg-[#F0FFF4] dark:bg-zinc-900 p-6 md:p-8 relative overflow-hidden group hover:shadow-2xl hover:shadow-green-500/20 transition-all duration-500 border border-green-100 dark:border-white/5"
          >
            {/* Dark Mode Gradient Overlay */}
            ...
            <div className="relative z-20 pb-28 md:pb-0">
              <h3 className="text-lg md:text-xl font-bold text-slate-900 dark:text-white mb-2">Proje Yönetimi</h3>
              <p className="text-xs md:text-sm text-slate-600 dark:text-slate-300 font-medium">Proje yöneticiniz, doğru freelance ekibi kurar ve süreci uçtan uca organize eder.</p>
            </div>
          ...
          <motion.div
            ...
            className="md:col-span-1 rounded-[32px] md:rounded-[48px] bg-[#EBF8FF] dark:bg-zinc-900 p-6 md:p-8 relative overflow-hidden group hover:shadow-2xl hover:shadow-sky-500/20 transition-all duration-500 border border-sky-100 dark:border-white/5"
          >
            {/* Dark Mode Gradient Overlay */}
            ...
            <div className="relative z-20 pb-24 md:pb-0">
              <h3 className="text-lg md:text-xl font-bold text-slate-900 dark:text-white mb-2">Tek Muhatap</h3>
              <p className="text-xs md:text-sm text-slate-600 dark:text-slate-300 font-medium">Tüm süreçte tek muhatabınız var; sözleşme, fatura ve sorumluluk bizde toplanır.</p>
            </div>
            <div className="absolute -bottom-10 md:-bottom-20 left-1/2 -translate-x-1/2 w-32 md:w-48 h-32 md:h-48 group-hover:w-40 md:group-hover:w-56 group-hover:h-40 md:group-hover:h-56 group-hover:-bottom-6 md:group-hover:-bottom-12 transition-all duration-500">
          ...
          <motion.div
            ...
            className="md:col-span-2 rounded-[32px] md:rounded-[48px] bg-[#FFF4ED] dark:bg-zinc-900 flex flex-col md:flex-row relative overflow-hidden group hover:shadow-2xl hover:shadow-orange-500/20 transition-all duration-500 border border-orange-100 dark:border-white/5"
          >
            {/* Dark Mode Gradient Overlay */}
            ...
            {/* Text Content */}
            <div className="relative z-20 flex-1 p-6 md:p-8 md:px-8 md:py-10 flex flex-col justify-center order-1 md:order-2">
              <h3 className="text-xl md:text-3xl font-bold text-slate-900 dark:text-white mb-3 md:mb-4 leading-tight">
            ...
            <div className="flex md:hidden w-full h-32 order-2">
               <div className="w-1/2 h-full overflow-hidden rounded-bl-[32px]">
                  <img 
               ...
               <div className="w-1/2 h-full overflow-hidden rounded-br-[32px]">
                  <img 
          ...
          <motion.div
            ...
            className="md:col-span-1 rounded-[32px] md:rounded-[48px] bg-[#F0F0FF] dark:bg-zinc-900 p-6 md:p-8 relative overflow-hidden group hover:shadow-2xl hover:shadow-purple-500/20 transition-all duration-500 border border-purple-100 dark:border-white/5"
          >
            {/* Dark Mode Gradient Overlay */}
            ...
            <div className="relative z-20 h-full flex flex-col justify-center">
              <div className="flex md:block justify-around md:space-y-5">
                <div className="text-center">
                  <span className="text-3xl md:text-4xl font-black bg-gradient-to-r from-purple-600 to-purple-400 bg-clip-text text-transparent">120+</span>
                  <p className="text-xs md:text-sm text-slate-600 dark:text-slate-300 font-medium mt-1">başarılı proje</p>
                </div>
                
                <div className="text-center">
                  <span className="text-3xl md:text-4xl font-black bg-gradient-to-r from-purple-600 to-purple-400 bg-clip-text text-transparent">200+</span>
                  <p className="text-xs md:text-sm text-slate-600 dark:text-slate-300 font-medium mt-1">freelancer</p>
                </div>
                
                <div className="text-center">
                  <span className="text-3xl md:text-4xl font-black bg-gradient-to-r from-purple-600 to-purple-400 bg-clip-text text-transparent">30+</span>
                  <p className="text-xs md:text-sm text-slate-600 dark:text-slate-300 font-medium mt-1">dijital hizmet</p>
                </div>
              </div>
            </div>
          </motion.div>
